...
Status: updated May 2026 Previous conflicts with design-tokens-v1.md resolved. This file is a usage guide. Raw values live in design-tokens-v1.md.

________________________________________
1. Philosophy
Dark, cinematic, founder-led, architectural, controlled, high-ticket B2B. Authority through restraint, not volume. One accent = one meaning. No visual noise.
...
________________________________________
3. Typography
Font: Onest (Google Fonts) — weights 300 / 400 / 500 / 600 / 700 / 800 Also in use: Manrope — preserve both, do not remove. Do not introduce new paid fonts without explicit approval.
Scale
