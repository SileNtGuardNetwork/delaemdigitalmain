    ...
    return withStorageTimeout(async () => {
      const { data, error } = await supabase
        ...
        .insert({
          ...
          utm_source: input.lead.attribution?.utmSource || null,
          utm_medium: input.lead.attribution?.utmMedium || null,
          utm_campaign: input.lead.attribution?.utmCampaign || null,
          utm_content: input.lead.attribution?.utmContent || null,
          utm_term: input.lead.attribution?.utmTerm || null,
          referrer: input.lead.attribution?.referrer || null,
          landing_path: input.lead.attribution?.landingPath || null,
